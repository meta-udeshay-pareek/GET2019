...
<%@include file="../partials/header.html" %>
	<form action="../update" method="post">
		...
		<span>Contact Number</span><input type="text" name="contactNo" value="${user.contactNo}" required /><br> 
		<span>Email Id</span><input type="text" name="email" required value="${user.email}" /><br> 
