...
public class NQueenProblem {
    ...
    { 
        for (int i = 0; i < this.noOfQueen; i++) 
        { 
            for (int j = 0; j < this.noOfQueen; j++) 
    ...
    to check only left side for attacking queens */
	 ...
	 { 
	     ...
	     for (i=row, j=col; j>=0 && i<this.noOfQueen; i++, j--) 
	         if (board[i][j] == 1) 
	             return false; 
