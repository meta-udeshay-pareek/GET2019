...
<jsp:useBean id="sampleTriangleProxyid" scope="session" class="com.metacube.triangle.TriangleProxy" />
<%
...
case 10:
        gotMethod = true;
        com.metacube.triangle.Triangle getTriangle10mtemp = sampleTriangleProxyid.getTriangle();
...
case 13:
        ...
        int side1_1idTemp  = Integer.parseInt(side1_1id);
        String side2_2id=  request.getParameter("side218");
        int side2_2idTemp  = Integer.parseInt(side2_2id);
        String side3_3id=  request.getParameter("side320");
        int side3_3idTemp  = Integer.parseInt(side3_3id);
        double getArea13mtemp = sampleTriangleProxyid.getArea(side1_1idTemp,side2_2idTemp,side3_3idTemp);
